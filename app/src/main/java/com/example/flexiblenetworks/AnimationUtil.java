...
public class AnimationUtil {
    ...
    public static void slideButtons(Context context,final FloatingDraftButton button){
        ...
        ArrayList<com.google.android.material.floatingactionbutton.FloatingActionButton> buttons = button.getButtons();
        ...
        if(button.isDraftable()){//可拖拽 展开Buttons
            ...
            if(buttonLeft >= radius && buttonRight >= radius
                ...
                for(int i=0;i<size;i++){
                    com.google.android.material.floatingactionbutton.FloatingActionButton faButton = buttons.get(i);
                ...
                if(buttonTop >= radius && buttonBottom >= radius){
                    if(buttonTop >buttonBottom){
                        com.google.android.material.floatingactionbutton.FloatingActionButton faButton = buttons.get(0);
