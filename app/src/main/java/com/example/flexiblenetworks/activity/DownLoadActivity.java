...
import com.example.flexiblenetworks.service.DownloadService;
...
public class DownLoadActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //动态申请SD卡读取权限
        if(ContextCompat.checkSelfPermission(DownLoadActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED){
